...
сообщает об изменении в модели
...
set button, строка, отображение кнопки 

set id, строка, получение id товара

set price, строка, отображение цены товара с условиями блокировки кнопки для бесценного товара

set title, тип строка, отображение заголовка
...
set image, типа строка,  отображение картинки
...
set description типа строка, отображает описание
...
в конструктор принимает разметку и событие
...
конструктор принимает HTML элемент и событие
